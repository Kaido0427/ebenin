...
/* ── Hero ── */
.ib-hero {
    background: linear-gradient(135deg, #0f0f4b 0%, #0f0f4b 60%, #1a73e8 100%);
...
/* ── CTA ── */
.ib-cta { background: linear-gradient(135deg, #0f0f4b 0%, #0f0f4b 100%); color: #fff; padding: 64px 0; text-align: center; }
